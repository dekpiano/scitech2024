...
<head>
    ...
    <link href="assets/css/variables-green.css?v=1" rel="stylesheet">
    <!-- <link href="assets/css/variables-orange.css" rel="stylesheet"> -->
    <!-- <link href="assets/css/variables-purple.css?v=1" rel="stylesheet"> -->
...
<body>
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <a href="index.php" class="logo d-flex align-items-center scrollto me-auto me-lg-0">
                ...
                <h4 class="d-none d-md-block">กลุ่มสาระการเรียนรู้วิทยาศาสตร์และเทคโนโลยี <br>
                    <small>โรงเรียนสวนกุหลาบวิทยาลัย (จิรประวัติ) นครสวรรค์</small>
                </h4>
            </a>
    ...
    <main id="main">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-5">
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                        <div class="service-item">
                            <div class="img">
                                <img src="https://bsite.in/wp-content/uploads/2018/09/ROV5.jpg" class="img-fluid" alt=""
                                    style="height: 300px;">
                            </div>
                            <div class="details position-relative">
                                <div class="icon">
                        ...
                        <div class="service-item">
                            ...
                            <div class="details position-relative">
                                ...
                                <div class="d-flex justify-content-around">
                                    ...
                                    <a class="btn-secondary w-100" target="_blank"
                                        href="https://docs.google.com/document/d/1-tHQCGzb3CduKc43qp2H1u_upU2_17Yn/edit?usp=drive_link&ouid=108470401055852821871&rtpof=true&sd=true"><i
                                            class="bi bi-file-earmark-text-fill"></i> กติกา</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                        <div class="service-item">
                            <div class="img">
                                <img src="https://i.ytimg.com/vi/5qKHm1ar8gc/maxresdefault.jpg" class="img-fluid" alt=""
                                    style="height: 300px;">
                            </div>
                            <div class="details position-relative">
                                <div class="icon">
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                        <div class="service-item">
                            <div class="img">
                                <img src="https://i.ytimg.com/vi/Ilg4qcBb88A/maxresdefault.jpg" class="img-fluid" alt=""
                                    style="height: 300px;">
                            </div>
                            <div class="details position-relative">
                                <div class="icon">
        ...
        <section id="map" class="map">
            <div class="container" data-aos="fade-up">
                <div class="section-header">
                    <h3>แผนผังภายในงาน</h3>
                </div>
                <div class="row">
                    <div class="col-md-6"><img class="img-fluid" src="img/map/map-main.jpg" alt=""></div>
                    <div class="col-md-6"><img class="img-fluid" src="img/map/map-front-stage.png" alt=""></div>
                </div>
        ...
        <section id="recent-blog-posts" class="recent-blog-posts">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    <h3>นิทรรศการเทิดพระเกียรติและพระปรีชาสามารถด้านวิทยาศาสตร์และเทคโนโลยี</h3>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="400">
                        <div class="post-box">
                            <div class="post-img"><img src="img/nitea/2.jpg" class="img-fluid" alt=""></div>

                            <h3 class="post-title">พระบาทสมเด็จพระบรมชนกาธิเบศร มหาภูมิพลอดุลยเดชมหาราช บรมนาถบพิตร</h3>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-6 footer-links">
                        <img src="img/2-2.png" alt="" class="img-fluid">
                    </div>
        ...
        <div class="footer-legal text-center">
            <div
                ...
                <div class="social-links order-first order-lg-last mb-3 mb-lg-0">
                    ...
                    <a href="https://www.facebook.com/SKJSCITECH" class="facebook"><i class="bi bi-facebook"></i></a>
